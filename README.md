...
> avoid discrepancies between images. To maintain snapshots for several simulators side by side —
> with the recording platform tracked in each snapshot's filename — see
> [Multi-Simulator Snapshots](Sources/SnapshotTesting/Documentation.docc/Articles/MultiSimulatorSnapshots.md).
