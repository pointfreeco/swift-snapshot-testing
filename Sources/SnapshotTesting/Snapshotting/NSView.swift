...
extension Snapshotting where Value == NSView, Format == NSImage {
  ...
  public static func image(precision: Float = 1, size: CGSize? = nil, format: ImageFormat = imageFormat) -> Snapshotting {
    return SimplySnapshotting.image(precision: precision, format: imageFormat).asyncPullback { view in
