  ...
  import ImageSerializationPlugin
    ...
    extension Snapshotting where Value == SCNScene, Format == NSImage {
      ...
      public static func image(precision: Float = 1, perceptualPrecision: Float = 1, size: CGSize, imageFormat: ImageSerializationFormat)
        -> Snapshotting
      {
        return .scnScene(precision: precision, perceptualPrecision: perceptualPrecision, size: size, imageFormat: imageFormat)
      }
    }
  #elseif os(iOS) || os(tvOS)
  ...
  extension Snapshotting where Value == SCNScene, Format == Image {
    fileprivate static func scnScene(precision: Float, perceptualPrecision: Float, size: CGSize, imageFormat: ImageSerializationFormat)
      -> Snapshotting
    {
