...
extension Platform {
  ...
  public static let knownSimulatedDevices: [SimulatedDevice] = [
    ...
    .init(name: "iPhone SE (1st generation)", modelIdentifier: "iPhone8,4", os: .iOS, gamut: .srgb, scale: 2),
    ...
    .init(name: "iPhone SE (2nd generation)", modelIdentifier: "iPhone12,8", os: .iOS, gamut: .p3, scale: 2),
    ...
    .init(name: "iPhone SE (3rd generation)", modelIdentifier: "iPhone14,6", os: .iOS, gamut: .p3, scale: 2),
    ...
    .init(name: "iPod touch (7th generation)", modelIdentifier: "iPod9,1", os: .iOS, gamut: .srgb, scale: 2),
    // iPad
    ...
    .init(name: "iPad Pro (12.9-inch) (1st generation)", modelIdentifier: "iPad6,8", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad (5th generation)", modelIdentifier: "iPad6,12", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (2nd generation)", modelIdentifier: "iPad7,1", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (10.5-inch)", modelIdentifier: "iPad7,3", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad (6th generation)", modelIdentifier: "iPad7,6", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad (7th generation)", modelIdentifier: "iPad7,12", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad Pro (11-inch) (1st generation)", modelIdentifier: "iPad8,1", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (3rd generation)", modelIdentifier: "iPad8,5", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (11-inch) (2nd generation)", modelIdentifier: "iPad8,9", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (4th generation)", modelIdentifier: "iPad8,12", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad mini (5th generation)", modelIdentifier: "iPad11,1", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air (3rd generation)", modelIdentifier: "iPad11,3", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad (8th generation)", modelIdentifier: "iPad11,7", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad (9th generation)", modelIdentifier: "iPad12,2", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad Air (4th generation)", modelIdentifier: "iPad13,2", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (11-inch) (3rd generation)", modelIdentifier: "iPad13,5", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (5th generation)", modelIdentifier: "iPad13,10", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air (5th generation)", modelIdentifier: "iPad13,17", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad (10th generation)", modelIdentifier: "iPad13,18", os: .iOS, gamut: .srgb, scale: 2),
    .init(name: "iPad mini (6th generation)", modelIdentifier: "iPad14,1", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (11-inch) (4th generation)", modelIdentifier: "iPad14,3", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (11-inch) (4th generation) (16GB)", modelIdentifier: "iPad14,4", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (6th generation)", modelIdentifier: "iPad14,5", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro (12.9-inch) (6th generation) (16GB)", modelIdentifier: "iPad14,5", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 11-inch (M2)", modelIdentifier: "iPad14,9", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 13-inch (M2)", modelIdentifier: "iPad14,11", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 11-inch (M3)", modelIdentifier: "iPad15,3", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 13-inch (M3)", modelIdentifier: "iPad15,5", os: .iOS, gamut: .p3, scale: 2),
    ...
    .init(name: "iPad Pro 11-inch (M4)", modelIdentifier: "iPad16,4", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 11-inch (M4) (16GB)", modelIdentifier: "iPad16,4", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 13-inch (M4)", modelIdentifier: "iPad16,6", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 13-inch (M4) (16GB)", modelIdentifier: "iPad16,6", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 11-inch (M4)", modelIdentifier: "iPad16,9", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Air 13-inch (M4)", modelIdentifier: "iPad16,11", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 11-inch (M5)", modelIdentifier: "iPad17,2", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 11-inch (M5) (16GB)", modelIdentifier: "iPad17,2", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 13-inch (M5)", modelIdentifier: "iPad17,4", os: .iOS, gamut: .p3, scale: 2),
    .init(name: "iPad Pro 13-inch (M5) (16GB)", modelIdentifier: "iPad17,4", os: .iOS, gamut: .p3, scale: 2),
    ...
    .init(name: "Apple TV", modelIdentifier: "AppleTV5,3", os: .tvOS, gamut: .unspecified, scale: 1),
    .init(name: "Apple TV 4K", modelIdentifier: "AppleTV6,2", os: .tvOS, gamut: .unspecified, scale: 2),
    .init(name: "Apple TV 4K (at 1080p)", modelIdentifier: "AppleTV6,2", os: .tvOS, gamut: .unspecified, scale: 1),
    .init(name: "Apple TV 4K (2nd generation)", modelIdentifier: "AppleTV11,1", os: .tvOS, gamut: .unspecified, scale: 2),
    .init(name: "Apple TV 4K (2nd generation) (at 1080p)", modelIdentifier: "AppleTV11,1", os: .tvOS, gamut: .unspecified, scale: 1),
    .init(name: "Apple TV 4K (3rd generation)", modelIdentifier: "AppleTV14,1", os: .tvOS, gamut: .unspecified, scale: 2),
    .init(name: "Apple TV 4K (3rd generation) (at 1080p)", modelIdentifier: "AppleTV14,1", os: .tvOS, gamut: .unspecified, scale: 1),
  ]
}
