...
public struct Snapshotting<Value, Format> {
  ...
  ///
  /// See the documention of `pullback` for a full description of how pullbacks works. This operation differs
  /// from `pullback` in that it allows you to use a transformation `(NewValue) -> Async<Value>`, which is
  /// necessary when your transformation needs to perform some asynchronous work.
  ///
  /// - Parameters:
